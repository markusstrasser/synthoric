...
export default ({ interactions, userInsights, sequence, knowledgeComponents }) => {
  ...
  3. 'userInsights' : the previous userInsights and learning insights that another AI System made about the user ie. assumed/inferred knowledge, skills, abilities, etc.)
